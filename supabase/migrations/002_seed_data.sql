...
INSERT INTO deals (id, name, company_id, contact_id, pipeline, stage, type, priority, value, closed_value, platforms, deliverables, terms, notes, jamey_uses_product, owner, created_at, last_activity_at, expected_close_date, closed_at) VALUES
  ...
  ('d-9', 'Higgsfield Sponsored Video', 'co-9', 'pe-9', 'content', 'Delivered', 'Sponsored Video', 'Medium', 1200, 1200, ARRAY['X'], 'Sponsored video', 'Came through Shown Media. Content delivered. In invoicing/collections.', NULL, true, 'both', '2026-02-01', '2026-03-15', NULL, '2026-03-15'),
  ...
  ('d-8', 'Block Brand Identity', 'co-8', 'pe-8', 'service', 'Delivered', 'Creative Direction', 'High', 5000, 5000, NULL, 'Brand identity consultation', NULL, NULL, false, 'jamey', '2026-02-15', '2026-03-20', NULL, '2026-03-20');
